...
class animation extends Transition {
    ...
    public static void OpenParent(Scene scene, Parent parent, Node node){
        if (timeline2.getStatus() == Status.STOPPED) {
            Stage pStage = (Stage) node.getScene().getWindow();
            timeline2 = new Timeline();
            final KeyFrame key_1 = new KeyFrame(Duration.millis(50), new KeyValue(scene.getRoot().opacityProperty(), 0.75));
            final KeyFrame key_2 = new KeyFrame(Duration.millis(150), new KeyValue(scene.getRoot().opacityProperty(), 0));
            timeline2.getKeyFrames().add(key_1);
            timeline2.getKeyFrames().add(key_2);
            EventHandler finish = new EventHandler<ActionEvent>() {
                public void handle(ActionEvent t) {
                    try {
                        ...
                        timeline2 = new Timeline();
                        final KeyFrame key_3 = new KeyFrame(Duration.millis(50), new KeyValue(scene.getRoot().opacityProperty(), 0.25));
                        final KeyFrame key_4 = new KeyFrame(Duration.millis(150), new KeyValue(scene.getRoot().opacityProperty(), 1));
                        timeline2.getKeyFrames().add(key_3);
                        timeline2.getKeyFrames().add(key_4);
                        timeline2.play();
                    } catch (Exception e){ }
                }
            };
    ...
    public static void start(Node node, Parent FXML1, Parent FXML2) {
      ...
      //  Stage stage = (Stage) node1.getScene().getWindow();
            ...
            Image img2 = scene2.snapshot(null);
        ...
        imgView2.setTranslateX(300);
            ...
            timeline.setOnFinished(t -> {
                ...
                root1.getChildren().setAll(FXML2);
                // set scene 2
                //scene.setRoot(FXML2);
